...
function Details() {
  ...
  useEffect(() => {
    ...
    let fetchMovie = async () => {
      try{
        let res = await fetch(`http://www.omdbapi.com/?i=${imdbID.imdbID}&apikey=c556ecbf`);
  ...
  return (
    <>
      <main className='bg-gradient-to-b from-white to-[#023047] h-screen'>
                ...
                <div>
                  ...
                  <div className='mt-10 flex gap-5'>
                    ...
                    <div className='group cursor-pointer rounded-full relative flex justify-center'>
                      <span class="material-symbols-rounded text-[30px] bg-[#fff]/10 text-[#fff] p-3 rounded-full hover:bg-[#023047] hover:text-white transition-all hover:scale-[1.1] hover:shadow-lg">
                        bookmark_add
                      </span>
